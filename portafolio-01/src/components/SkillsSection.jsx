...
const skills = [
    ...
    {name: "Jakarta", level:90, category: "backend"},
    {name: "Java EE", level:90, category: "backend"},
    {name: "SOAP", level:80, category: "backend"},
    {name: "Spring boot", level:90, category: "backend"},
    {name: "Spring Web", level:90, category: "backend"},
    {name: "Spring Data JPA", level:90, category: "backend"},
    ...
    {name: "bitbucket", level:100, category: "tools"},
