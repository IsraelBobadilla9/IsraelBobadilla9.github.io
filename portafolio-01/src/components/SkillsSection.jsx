...
const skills = [
    ...
    {name: "Jakarta", level:95, category: "backend"},
    {name: "Spring boot", level:95, category: "backend"},
    {name: "Spring Web", level:95, category: "backend"},
    {name: "Spring Data JPA", level:95, category: "backend"},
    ...
    {name: "Kubernetes", level:95, category: "tools"},
    {name: "Jira", level:95, category: "tools"},
    {name: "JMeter", level:95, category: "tools"},
