            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs">
                        ...
                        <p className=" font-semibold mb-6">(No working,i dont have money to pay the service)</p>
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea  id="message" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary resize-none"
